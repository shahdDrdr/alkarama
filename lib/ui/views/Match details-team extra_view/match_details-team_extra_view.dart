...
class MatchDetailsIeamExtraView extends StatefulWidget {
  ...
  @override
  State<MatchDetailsIeamExtraView> createState() =>
      _MatchDetailsIeamExtraViewState();
}
    ...
    return SafeArea(
      ...
      body: ListView(
        padding: EdgeInsetsDirectional.only(
            start: screenWidth(22), end: screenWidth(22), top: screenWidth(10)),
        children: [
          Container(
            height: screenWidth(3.5),
            margin: EdgeInsetsDirectional.only(
                start: screenWidth(22), end: screenWidth(22)),
            padding: EdgeInsetsDirectional.only(
            ...
            child: CustomResults(
                number: '5', numbertwo: '0', date: 'السبت 12/12 12:2م'),
          ),
          Row(
            ...
            children: [
              ...
              CustomBorder(name: 'الاحتياط', tap: () {}, border: true),
            ],
          ),
          Container(
